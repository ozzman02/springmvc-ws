...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long> {
    ...
    @Query(value = "select user from UserEntity user join fetch user.addresses where user.email =:email")
    ...
    /* Use this query when using MySQL
    ...
    @Query(value = "select u.first_name, u.last_name from Users u where u.first_name LIKE %:keyword% or" +
            " u.last_name LIKE %:keyword%", nativeQuery = true)
    ...
    @Modifying
    @Transactional
    @Query(value = "delete from Users where email = 'test@test.com'", nativeQuery = true)
